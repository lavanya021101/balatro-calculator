# Joker Name - Effect as Stated

Source: `structured-data.jsonld`
...
Juggler - +1 hand size
Drunkard - +1 discard
Acrobat - X3 Mult on final hand of round (Currently inactive)
...
Banner - +30 Chips for each remaining discard (Currently +0 Chips)
Mystic Summit - +15 Mult when 0 discards remaining (Currently inactive)
...
Misprint - +0 - +23 Mult
Steel Joker - This Joker gains X0.2 Mult for each Steel Card in your full deck (Currently X1 Mult)
...
Glass Joker - This Joker gains X0.75 Mult for every Glass Card that is destroyed (Currently X1 Mult)
...
Wee Joker - This Joker gains +8 Chips when each played 2 is scored (Currently +0 Chips)
Business Card - Played Face cards have a 1 in 2 chance to give $2 when scored
Supernova - Adds the number of times poker hand has been played to Mult (Currently +0 Mult)
...
Hit the Road - This Joker gains X0.5 Mult per discarded Jack this round (Currently X1)
...
Ride the Bus - This Joker gains +1 Mult per consecutive hand played without a scoring face card (Currently +0)
...
Invisible Joker - After 2 rounds, sell this card to duplicate a random Joker (Currently 0/2)
...
Dusk - Retrigger all played cards in final hand of round (Currently inactive)
...
Satellite - Earn $1 at the end of round per unique Planet card used this run (Currently $0)
...
Canio - Gains X1 Mult when a face card is destroyed (Currently X1 Mult)
Triboulet - Played Kings and Queens each give X2 Mult when scored
Yorick - This Joker gains X1 Mult every 23 [23] cards discarded (Currently X1 Mult)
...
Bootstraps - +2 Mult for every $5 you have (Currently +0 Mult)
...
Constellation - This Joker gains X0.1 Mult per Planet card used (Currently X1 Mult)
...
Card Sharp - X3 Mult if played poker hand has already been played this round (Currently inactive)
Red Card - This Joker gains +3 Mult when any Booster Pack is skipped (Currently +0 Mult)
Madness - When Small Blind or Big Blind is selected, gain X0.5 Mult and destroy a random Joker (Currently X1 Mult)
Square Joker - This Joker gains +4 Chips if played hand has exactly 4 card (Currently +0 Chips)
...
Hologram - This Joker gains X0.25 Mult  per playing card added to your deck (Currently X1 Mult)
...
Obelisk - This Joker gains X0.2 Mult per consecutive hand played without playing your must played poker hand (Currently X1 Mult)
...
Erosion - +4 Mult for each card below 52 in your full deck (Currently +0)
...
Lucky Cat - This Joker gains X0.25 Mult each time a Lucky card successfully triggers (currently X1 Mult)
...
Spare Trousers - Gain +2 Mult if played hand contains a Two Pair (Currently +0 Mult)
...
Castle - This Joker gains +3 Chips per discarded Heart card, suit changes every round (Currently +0 Chips)
